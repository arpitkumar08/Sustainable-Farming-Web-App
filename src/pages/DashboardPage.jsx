...
export default function DashboardPage() {
  ...
  return (
    // ⬇⬇ MAIN CHANGE HERE: solid background instead of gradient,
    // so it matches header/sidebar and no white border.
    <section className="flex-1 p-4 md:p-6 space-y-5 overflow-y-auto bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <div className="rounded-2xl bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 p-4 md:p-5 space-y-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr,1.6fr] gap-4 md:gap-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-3 md:gap-4">
            ...
            {methods.map((method) => (
              <button
                ...
                className="group relative text-left rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-50 via-white to-emerald-50/40 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-900/20 hover:from-emerald-50 hover:via-white hover:to-emerald-100/50 dark:hover:from-slate-900 dark:hover:via-slate-900 dark:hover:to-emerald-900/40 transition-all duration-300 flex flex-col justify-between p-3 md:p-4 shadow-xs hover:shadow-md hover:-translate-y-0.5"
              >
          ...
          <div className="flex justify-between">
            {/* Adoption graph card */}
            <div className="rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 flex gap-3 w-1/3">
            ...
            {/* Upcoming events card with conveyor behaviour */}
            <div className="w-64 ml-3">
              <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3 shadow-sm">
                ...
                <p className="mt-2 text-[10px] text-slate-500 dark:text-slate-400">
                  Two events are shown at a time and scroll automatically every 5 seconds.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Schemes section and rest of dashboard remain unchanged */}
      <div className="rounded-2xl bg-white/90 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 p-4 md:p-5 space-y-4 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="h-8 w-8 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 text-sm transition-colors"
              >
                ‹
              </button>
              <button
          ...
          <>
            <div className="flex flex-col lg:flex-row gap-4 items-stretch">
              <button
                ...
                className="group flex-1 flex flex-col lg:flex-row gap-3 text-left rounded-2xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-50 via-white to-emerald-50/40 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-900/20 hover:from-emerald-50 hover:via-white hover:to-emerald-100/60 dark:hover:from-slate-900 dark:hover:via-slate-900 dark:hover:to-emerald-900/40 transition-all duration-300 overflow-hidden shadow-xs hover:shadow-md hover:-translate-y-0.5"
              >
                <div className="w-full lg:w-1/3 h-40 lg:h-auto bg-slate-200 dark:bg-slate-800 flex items-center justify-center overflow-hidden relative">
                    ...
                    <div className="flex flex-wrap gap-1 mt-2">
                      {activeScheme.focusAreas &&
                        activeScheme.focusAreas.map((area) => (
                          <span
                            key={area}
                            className="text-[10px] px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700"
                          >
                            {area}
                          </span>
                        ))}
              ...
              <div className="w-full lg:w-56 flex flex-col justify-between gap-3 text-xs">
                ...
                <div className="rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-3 shadow-xs">
                  <p className="text-[11px] text-slate-700 dark:text-slate-300">Note</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 space-y-2 shadow-sm">
          <p className="text-xs text-slate-500 dark:text-slate-400">Getting started</p>
        ...
        <div className="rounded-2xl bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-100 dark:border-emerald-700 p-4 space-y-2 shadow-sm">
          <p className="text-xs text-emerald-700 dark:text-emerald-200">Tip</p>
        ...
        <div className="rounded-2xl bg-sky-50 dark:bg-sky-900/30 border border-sky-100 dark:border-sky-800 p-4 space-y-2 shadow-sm">
          <p className="text-xs text-sky-700 dark:text-sky-200">Goal</p>
      ...
      {selectedMethod && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 px-3">
          <div className="w-full max-w-4xl rounded-2xl bg-white dark:bg-slate-900 shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden animate-[fadeIn_0.18s_ease-out]">
            <div className="flex items-center justify-between px-4 md:px-6 py-3 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800">
              <div>
                <p className="text-[11px] text-slate-500 dark:text-slate-400">
                  Sustainable method
                </p>
              ...
              <button
                ...
                className="text-xs px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700"
              >
                Close
              </button>
            </div>
            ...
            <div className="p-4 md:p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 flex flex-col">
                      ...
                      return (
                        ...
                        >
                          <div className="w-full max-w-[24px] rounded-t-lg bg-emerald-100 dark:bg-emerald-900/40 flex items-end justify-center overflow-hidden">
                            <div
                              className="w-full bg-gradient-to-t from-emerald-500 to-emerald-300 dark:from-emerald-500 dark:to-emerald-300 transition-all duration-500"
                              style={{ height: `${height}%` }}
                            />
                          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                <div className="md:col-span-2 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 md:p-4">
                  <p className="text-xs font-semibold text-slate-900 dark:text-slate-50 mb-1">
                ...
                <div className="rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 md:p-4 flex flex-col gap-2">
                  <p className="text-xs font-semibold text-slate-900 dark:text-slate-50">
            ...
            <div className="p-4 md:p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 flex flex-col gap-2">
                  ...
                  <div className="h-24 rounded-lg bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-[11px] text-slate-600 dark:text-slate-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                <div className="md:col-span-2 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-3 md:p-4 space-y-2">
                  <p className="text-xs font-semibold text-slate-900 dark:text-slate-50">
